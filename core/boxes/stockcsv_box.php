 ...
 */
class stockcsvbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "stockcsv@stockcsv";
    public $boxlabel;
    public $depends = array("stockcsv");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/stockcsv/class/stockcsv.class.php";
